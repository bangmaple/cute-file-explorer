...
const Sorting = () => {
  ...
  return (
    <div className="main-sorting-nav d-flex">
      <div
        onClick={() => dispatchToggleListRendering(true)}
        className={`app-filter-button d-flex-center app-filter-button-left
                  ${isListRendering ? "app-filter-button-selected" : ""}`}
      >
        <i className="fas fa-bars font-size-1-half"></i>
      </div>
      <div
        onClick={() => dispatchToggleListRendering(false)}
        className={`app-filter-button d-flex-center app-filter-button-right
                ${!isListRendering ? "app-filter-button-selected" : ""}`}
      >
